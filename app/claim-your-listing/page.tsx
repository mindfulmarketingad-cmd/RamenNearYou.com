...
export const metadata = {
  ...
  description: 'Get the #1 featured spot at the top of the ramen search map near you. $49.99/month — your restaurant shows up first when people search for ramen nearby.',
      ...
      <div className="max-w-xl mx-auto px-4 sm:px-6 pt-28 pb-20">
        <div className="text-center mb-10">
          ...
          <p className="text-[#6B6862] leading-relaxed max-w-md mx-auto">
            Get the <strong className="text-[#1E2026]">#1 featured spot</strong> at the top of the ramen search map — your restaurant appears first when someone searches for ramen near you. Just $49.99/month.
          </p>
        </div>
