    ...
    <main className="min-h-screen bg-surface">
      ...
      <section className="pt-28 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-ink mb-3">Disclaimer</h1>
          ...
          <div className="prose prose-invert max-w-none space-y-10 text-ink-soft leading-relaxed">
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">1. General Information</h2>
              <p>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">2. Restaurant Listings &amp; Information</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">3. No Professional Advice</h2>
              <p>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">4. External Links Disclaimer</h2>
              <p>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">5. Affiliate &amp; Advertising Disclaimer</h2>
              <p>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">6. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">7. Changes to This Disclaimer</h2>
              <p>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">8. Contact Us</h2>
              <p>
              ...
              <div className="mt-3 p-4 bg-sunken rounded-xl border border-line/5 text-sm">
                ...
                <p>Email: <a href="mailto:hello@ramennearyou.com" className="text-brand-ink hover:underline">hello@ramennearyou.com</a></p>
