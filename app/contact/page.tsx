    ...
    <main className="min-h-screen bg-[#2F323A]">
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-24">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          {/* Form */}
          <div className="lg:col-span-2 bg-[#1E2026] border border-white/5 rounded-2xl p-6 sm:p-8">
            {status === 'sent' ? (
              <div className="flex flex-col items-center justify-center h-full py-16 text-center gap-4">
                <div className="w-12 h-12 rounded-full bg-emerald-500/15 flex items-center justify-center">
                  <Mail className="w-5 h-5 text-emerald-400" />
                </div>
                <h2 className="font-serif text-2xl font-bold text-white">Message sent!</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <h2 className="font-serif text-xl font-bold text-white mb-1">Send a message</h2>
                <p className="text-[#B0B3BB] text-sm mb-6">We typically respond within 1–2 business days.</p>
                ...
                <div>
                  <label className="block text-sm text-[#B0B3BB] mb-1.5">Subject</label>
                  <select
                    value={subject}
