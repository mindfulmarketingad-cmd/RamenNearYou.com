    ...
    <main className="min-h-screen bg-surface">
      ...
      <section className="pt-28 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-brand-ink text-xs font-medium uppercase tracking-widest mb-3">Event Catering</p>
      ...
      <section className="pb-20 px-4 sm:px-6 lg:px-8">
        <article className="max-w-3xl mx-auto">
          ...
          <h2 className="font-serif text-xl sm:text-2xl font-bold text-ink mb-3 mt-10">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-ink font-semibold text-base mb-1">Live ramen bar</h3>
            ...
            <div>
              <h3 className="text-ink font-semibold text-base mb-1">Buffet or family-style</h3>
              <p className="text-ink-soft text-[15px] leading-relaxed">
            ...
            <div>
              <h3 className="text-ink font-semibold text-base mb-1">Drop-off and DIY kits</h3>
              <p className="text-ink-soft text-[15px] leading-relaxed">
          ...
          <ul className="space-y-2.5 mb-4">
            {[
              ...
              <li key={t} className="flex items-start gap-2.5 text-ink-soft text-[15px] leading-relaxed">
          ...
          <h2 className="font-serif text-xl sm:text-2xl font-bold text-ink mb-5 mt-10">
            Ramen catering FAQ
          </h2>
          <div className="space-y-4">
            {faqs.map(({ q, a }) => (
