...
export default function CateringForm() {
  ...
  const inputClass = 'w-full px-4 py-3 bg-[#ffffff] border border-black/8 rounded-lg text-[#1E2026] placeholder-[#9B9490]/60 text-sm outline-none focus:border-[#B57F50] transition-colors'
    ...
    return (
      <div className="bg-[#F5F4F0] rounded-xl border border-black/5 p-8 text-center">
        ...
        <p className="text-[#6B6862] leading-relaxed">
          ...
          <span className="text-[#1E2026]">{form.email}</span>.
        </p>
      </div>
    )
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-[#F5F4F0] rounded-xl border border-black/5 p-8 space-y-5">
      {error && (
