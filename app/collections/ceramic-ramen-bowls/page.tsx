      ...
      <section className="pt-28 pb-12 px-4 sm:px-6 bg-sunken border-b border-line/5">
        <div className="max-w-5xl mx-auto">
          ...
          <nav className="flex items-center gap-1.5 text-xs text-ink-soft mb-6">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-ink">Ceramic Ramen Bowls</span>
          </nav>

          <div className="flex items-center gap-2 mb-3">
            <ShoppingBag className="w-4 h-4 text-brand-ink" />
            <p className="text-brand-ink text-xs font-medium uppercase tracking-widest">Ramen Accessories</p>
          </div>
      ...
      <section className="py-12 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-16 bg-surface rounded-2xl border border-line/5 p-8">
            <h2 className="font-serif text-2xl font-bold text-ink mb-4">What to Look for in a Ramen Bowl</h2>
            <div className="grid sm:grid-cols-3 gap-6 text-sm text-ink-soft leading-relaxed">
              <div>
                <p className="font-semibold text-ink mb-1">Size</p>
              ...
              <div>
                <p className="font-semibold text-ink mb-1">Heat Retention</p>
              ...
              <div>
                <p className="font-semibold text-ink mb-1">Shape</p>
          ...
          <div className="mt-8 p-5 rounded-2xl bg-brand/8 border border-brand/20">
            <p className="text-ink text-sm font-semibold mb-2">Ready to use your new bowl?</p>
            <p className="text-ink-soft text-sm">
              Read our guide to <Link href="/blog/tonkotsu-vs-shoyu-vs-shio-vs-miso-4-types-of-ramen" className="text-brand-ink underline font-medium">the 4 types of ramen</Link> to know exactly what to make — or find a great ramen restaurant near you in our <Link href="/cities" className="text-brand-ink underline font-medium">city directory</Link>. Looking for <Link href="/tonkotsu-ramen-near-me" className="text-brand-ink underline font-medium">tonkotsu ramen near you</Link> or <Link href="/miso-ramen-near-me" className="text-brand-ink underline font-medium">miso ramen near you</Link>? Browse by broth type.
            </p>
          </div>
        </div>
      </section>
