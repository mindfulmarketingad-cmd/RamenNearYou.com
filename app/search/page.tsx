...
function Badge({ children }: { children: React.ReactNode }) {
  return (
    <span className="px-2 py-0.5 rounded-full bg-[#B57F50]/15 text-[#96602F] text-xs font-medium">
      {children}
    </span>
  )
}
    ...
    <main className="min-h-screen bg-[#ffffff]">
      ...
      <section className="pt-28 pb-12 px-4 sm:px-6 lg:px-8 bg-[#F5F4F0] border-b border-black/5">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-[#96602F] text-xs font-medium uppercase tracking-widest mb-3">Search Results</p>
        ...
        <div className="max-w-7xl mx-auto">
          {results.length > 0 ? (
                ...
                >
                  <div className="relative w-full h-44 bg-[#ffffff] overflow-hidden">
                    {safePhotoSrc(r.photo) ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center text-[#96602F]/30">
                  ...
                  <div className="flex flex-col flex-1 p-5 gap-3">
                    ...
                    <div className="mt-auto pt-2 border-t border-black/5 flex items-center justify-between">
                      ...
                      <span className="ml-auto text-[#96602F] text-xs font-medium group-hover:underline">
                        View listing →
                      </span>
                    </div>
                  </div>
            ...
            <div className="text-center py-20">
              <Search className="w-12 h-12 text-[#96602F]/30 mx-auto mb-4" />
