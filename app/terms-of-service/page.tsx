    ...
    <main className="min-h-screen bg-surface">
      ...
      <section className="pt-28 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-ink mb-3">Terms of Service</h1>
          <p className="text-ink-soft text-sm mb-12">Last updated: {lastUpdated}</p>

          <div className="space-y-10 text-ink-soft leading-relaxed">

            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">1. Acceptance of Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">2. Description of Service</h2>
              <p>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">3. Accuracy of Restaurant Information</h2>
              <p>
                ...
                this information accurate and up to date, but <strong className="text-ink">we do not guarantee
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">4. User Accounts</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">5. Restaurant Listings &amp; Claims</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">6. Acceptable Use</h2>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">7. Intellectual Property</h2>
              <p>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">9. Disclaimer of Warranties</h2>
              <p>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">10. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">11. Indemnification</h2>
              <p>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">12. Governing Law</h2>
              <p>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">13. Changes to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-ink text-xl font-semibold mb-3">14. Contact Us</h2>
              <p>
              ...
              <div className="mt-3 p-4 bg-sunken rounded-xl border border-line/5 text-sm">
                ...
                <p>Email: <a href="mailto:legal@ramennearyou.com" className="text-brand-ink hover:underline">legal@ramennearyou.com</a></p>
