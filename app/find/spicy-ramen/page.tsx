...
export default async function SpicyRamenPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Spicy Ramen Near Me" }]}
        title={`Spicy Ramen Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
