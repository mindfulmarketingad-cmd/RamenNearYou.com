...
export default async function ChickenKatsuRamenPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Chicken Katsu Ramen Near Me" }]}
        title={`Chicken Katsu Ramen Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
