...
export default async function RamenSushiPage() {
  const NATIONWIDE_FILTER = { initialFlags: ["ramen-sushi"] }
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Ramen and Sushi Near Me" }]}
        title={`Ramen and Sushi Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
