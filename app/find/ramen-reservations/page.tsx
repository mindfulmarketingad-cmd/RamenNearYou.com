...
export default async function RamenReservationsPage() {
  const NATIONWIDE_FILTER = { initialFlags: ["reservations"] }
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Ramen With Reservations Near Me" }]}
        title={`Ramen With Reservations Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
