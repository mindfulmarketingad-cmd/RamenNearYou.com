...
export default async function RamenHiddenGemsPage() {
  const NATIONWIDE_FILTER = { initialFlags: ["hidden-gems"] }
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Hidden Gem Ramen Near Me" }]}
        title={`Hidden Gem Ramen Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
