...
export default async function BeefRamenPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Beef Ramen Near Me" }]}
        title={`Beef Ramen Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
