...
export default async function TopRatedRamenPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Top Rated Ramen Near Me" }]}
        title={`Top Rated Ramen Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
