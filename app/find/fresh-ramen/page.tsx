...
export default async function FreshRamenPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Fresh Ramen Noodles Near Me" }]}
        title={`Fresh Ramen Noodles Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
