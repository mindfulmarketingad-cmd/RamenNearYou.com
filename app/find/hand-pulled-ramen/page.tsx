...
export default async function HandPulledRamenPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Hand Pulled Ramen Near Me" }]}
        title={`Hand Pulled Ramen Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
