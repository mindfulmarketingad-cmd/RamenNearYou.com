...
export default async function RamenDeliveryPage() {
  const NATIONWIDE_FILTER = { initialFlags: ["delivers"] }
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Ramen Delivery Near Me" }]}
        title={`Ramen Delivery Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
