...
export default async function RamenOpenEarlyPage() {
  const NATIONWIDE_FILTER = { initialFlags: ["open-early"] }
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Ramen Open Early Near Me" }]}
        title={`Ramen Open Early Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
