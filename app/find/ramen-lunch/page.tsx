...
export default async function RamenLunchPage() {
  const NATIONWIDE_FILTER = { initialMoods: ["quick-lunch"] }
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Ramen for Lunch Near Me" }]}
        title={`Ramen for Lunch Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
