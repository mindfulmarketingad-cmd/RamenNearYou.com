...
export default async function RamenFreeParkingPage() {
  const NATIONWIDE_FILTER = { initialFlags: ["free-parking"] }
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Ramen With Free Parking Near Me" }]}
        title={`Ramen With Free Parking Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
