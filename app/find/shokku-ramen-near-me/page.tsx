...
export default async function ShokkuRamenPage() {
  const NATIONWIDE_FILTER = { initialFlags: ["shokku"] }
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Shokku Ramen Near Me" }]}
        title={`Shokku Ramen Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
