...
export default async function RamenOpenNowPage() {
  const NATIONWIDE_FILTER = { initialFlags: ["open-now"] }
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Ramen Open Now Near Me" }]}
        title={`Ramen Open Now Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
