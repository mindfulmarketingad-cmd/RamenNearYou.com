...
export default async function MuroranCurryRamenPage() {
  const NATIONWIDE_FILTER = { initialFlags: ["muroran-curry"] }
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Muroran Curry Ramen Near Me" }]}
        title={`Muroran Curry Ramen Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
