...
export default async function AuthenticRamenPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Authentic Ramen Near Me" }]}
        title={`Authentic Ramen Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
