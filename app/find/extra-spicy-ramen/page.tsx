...
export default async function ExtraSpicyRamenPage() {
  const NATIONWIDE_FILTER = { initialMoods: ["extra-spicy"] }
  ...
  return (
    <main className="min-h-screen bg-white">
      <Navbar />
      <PseoListicle
        breadcrumb={[{ label: 'Ramen Near You', href: '/' }, { label: 'Find Ramen', href: '/find' }, { label: "Extra Spicy Ramen Near Me" }]}
        title={`Extra Spicy Ramen Near Me — ${count} Spot${count === 1 ? '' : 's'}`}
