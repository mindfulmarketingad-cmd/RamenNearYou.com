    ...
    <main className="min-h-screen bg-surface">
      ...
      <section className="pt-28 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          <p className="text-brand-ink text-xs font-medium uppercase tracking-widest mb-3">Free Listing</p>
          <h1 className="font-serif text-4xl font-bold text-ink mb-2">Submit Your Restaurant</h1>
