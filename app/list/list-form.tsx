...
export default function ListForm() {
  ...
  if (status === 'success') {
    return (
      <div className="bg-[#1E2026] rounded-xl border border-white/5 p-10 text-center">
        <div className="w-14 h-14 rounded-full bg-emerald-500/15 flex items-center justify-center mx-auto mb-4">
          <CheckCircle2 className="w-7 h-7 text-emerald-400" />
        </div>
        <h2 className="font-serif text-2xl font-bold text-white mb-2">Submission Received!</h2>
        <p className="text-[#B0B3BB] leading-relaxed max-w-sm mx-auto">
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-[#1E2026] rounded-xl border border-white/5 p-6 space-y-4">
        <h2 className="font-semibold text-white text-base mb-1">Restaurant Details</h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          ...
          <div>
            <label className="block text-sm text-[#B0B3BB] mb-1.5">ZIP Code</label>
            <input
        ...
        <div>
          <label className="block text-sm text-[#B0B3BB] mb-1.5">Hours</label>
          <input
        ...
        <div>
          <label className="block text-sm text-[#B0B3BB] mb-2">Broth Types Served</label>
      ...
      {/* Owner contact */}
      <div className="bg-[#1E2026] rounded-xl border border-white/5 p-6 space-y-4">
        <h2 className="font-semibold text-white text-base mb-1">Your Contact Info</h2>
        <p className="text-[#B0B3BB] text-xs -mt-2">So we can reach you when your listing is approved.</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block text-sm text-[#B0B3BB] mb-1.5">Your Name</label>
            <input
          ...
          <div>
            <label className="block text-sm text-[#B0B3BB] mb-1.5">Your Email</label>
            <input
