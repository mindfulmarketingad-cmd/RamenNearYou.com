...
export default function ListForm() {
  ...
  if (status === 'success') {
    return (
      <div className="bg-sunken rounded-xl border border-line/5 p-10 text-center">
        ...
        <Link
          href="/"
          className="inline-block mt-6 px-5 py-2.5 rounded-none bg-brand text-white text-sm font-medium hover:bg-brand-hi transition-colors"
        >
          Back to Home
        </Link>
      </div>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-sunken rounded-xl border border-line/5 p-6 space-y-4">
        <h2 className="font-semibold text-ink text-base mb-1">Restaurant Details</h2>
        ...
        <div>
          <label className="block text-sm text-ink-soft mb-1.5">Restaurant Name <span className="text-brand-ink">*</span></label>
          <input
        ...
        <div>
          <label className="block text-sm text-ink-soft mb-1.5">Street Address <span className="text-brand-ink">*</span></label>
          <input
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          <div className="col-span-2 sm:col-span-1">
            <label className="block text-sm text-ink-soft mb-1.5">City <span className="text-brand-ink">*</span></label>
            <input
          ...
          <div>
            <label className="block text-sm text-ink-soft mb-1.5">State <span className="text-brand-ink">*</span></label>
            <select
          ...
          <div>
            <label className="block text-sm text-ink-soft mb-1.5">ZIP Code</label>
            <input
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block text-sm text-ink-soft mb-1.5">Phone</label>
            <input
          ...
          <div>
            <label className="block text-sm text-ink-soft mb-1.5">Website</label>
            <input
        ...
        <div>
          <label className="block text-sm text-ink-soft mb-1.5">Hours</label>
          <input
        ...
        <div>
          <label className="block text-sm text-ink-soft mb-2">Broth Types Served</label>
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-xs font-medium border transition-all ${
                  brothTypes.includes(type)
                    ...
                    : 'border-line/8 text-ink-soft hover:border-white/30 hover:text-ink'
                }`}
              >
                {type}
              </button>
      ...
      {/* Owner contact */}
      <div className="bg-sunken rounded-xl border border-line/5 p-6 space-y-4">
        <h2 className="font-semibold text-ink text-base mb-1">Your Contact Info</h2>
        <p className="text-ink-soft text-xs -mt-2">So we can reach you when your listing is approved.</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
          ...
          <div>
            <label className="block text-sm text-ink-soft mb-1.5">Your Email</label>
            <input
      ...
      <button
        ...
        className="w-full py-3.5 rounded-none bg-brand hover:bg-brand-hi text-white text-sm font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
