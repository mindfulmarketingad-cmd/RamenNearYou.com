  ...
  return (
    <section id="catering" className="py-20 px-4 sm:px-6 lg:px-8 bg-[#B57F50]" ref={ref}>
      <div className="max-w-4xl mx-auto text-center">
        <p className="fade-up text-[#1E2026]/60 text-xs font-medium uppercase tracking-widest mb-4">Event Catering</p>
        <h2 className="fade-up font-serif text-4xl sm:text-5xl font-bold text-[#1E2026] leading-tight text-balance mb-5">
          Need Ramen Catering<br />for Your Event?
        </h2>
        <p className="fade-up text-[#1E2026]/80 text-base sm:text-lg max-w-xl mx-auto leading-relaxed mb-10">
        ...
        <div className="fade-up flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <p className="text-[#1E2026]/60 text-sm">No commitment. Matched in minutes.</p>
        </div>
      </div>
    </section>
  )
