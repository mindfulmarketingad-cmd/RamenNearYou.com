    ...
    <section className="pt-10 pb-4 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-5">
          ...
          <button
            onClick={() => setOpen((v) => !v)}
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-black/10 bg-[#F5F4F0] hover:border-[#B57F50]/40 text-[#6B6862] hover:text-[#B57F50] text-xs font-medium transition-colors"
          >
            {open ? (
