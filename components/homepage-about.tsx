  ...
  return (
    <section className="bg-surface py-14 sm:py-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <p className="text-brand-ink text-xs font-semibold uppercase tracking-widest mb-2">About RamenNearYou</p>
        ...
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mb-6 pb-6 border-b border-line/5">
        ...
        <p className="text-ink-deep text-[15px] leading-relaxed mb-4 pl-4 border-l-2 border-brand/30">
        ...
        <p className="text-ink-deep text-[15px] leading-relaxed mb-4">
        ...
        <h3 className="font-serif text-xl font-bold text-ink mt-8 mb-3 flex items-center gap-2.5">
        ...
        <p className="text-ink-deep text-[15px] leading-relaxed mb-4">
          ...
          also built dedicated pages for specific cravings — <Link href="/find/ramen-open-now" className="link-underline text-brand-ink font-medium">ramen open now</Link>,{' '}
          <Link href="/find/vegan-ramen" className="link-underline text-brand-ink font-medium">vegan ramen</Link>,{' '}
          <Link href="/find/tonkotsu-ramen" className="link-underline text-brand-ink font-medium">tonkotsu ramen</Link>, and{' '}
          <Link href="/find/ramen-delivery" className="link-underline text-brand-ink font-medium">ramen delivery</Link> — so
        ...
        <p className="text-ink-deep text-[15px] leading-relaxed mb-4">
          ...
          every restaurant on RamenNearYou links out to a full <Link href="/reviews" className="link-underline text-brand-ink font-medium">review breakdown</Link> covering
        ...
        <p className="text-ink-deep text-[15px] leading-relaxed">
          Ready to find your next bowl? <Link href="/find" className="link-underline text-brand-ink font-semibold">Search ramen near you</Link> or{' '}
          <Link href="/cities" className="link-underline text-brand-ink font-semibold">browse every city and state</Link> in
          our directory.
        </p>
      </div>
    </section>
