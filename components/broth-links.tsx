        ...
        {links.map((link) => (
          <div key={link.href}>
            <Link href={link.href} className="group inline-flex items-center gap-2">
              <h2 className="broth-carousel-title font-serif text-3xl sm:text-4xl font-bold group-hover:text-[#B57F50] transition-colors">
                {link.title}
              </h2>
              <ChevronRight className="w-6 h-6 text-[#B57F50] shrink-0 transition-transform group-hover:translate-x-1" />
            </Link>
