...
function StaticChip({ label, emoji, hex }: { label: string; emoji: string; hex: string }) {
  return (
    <span
      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold border border-line/10 bg-surface text-ink whitespace-nowrap select-none"
    >
...
export default function FilterShowcase() {
  return (
    <section className="bg-sunken border-t border-line/8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="mb-8">
          <p className="text-brand-ink text-xs font-semibold uppercase tracking-widest mb-1">Powerful Filters</p>
        ...
        {/* Filter preview card */}
        <div className="bg-surface rounded-2xl border border-line/8 shadow-sm p-5 sm:p-6 space-y-5 mb-8">
          <div>
